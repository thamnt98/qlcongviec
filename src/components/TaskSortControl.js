                ...
                <div className="dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
                        ...
                        <li onClick={ () => this.onClick('startdate', 1) }>
                            <a
                                role="button"
                                className={(this.props.sort.by === 'startdate' && this.props.sort.value === 1) ? 'sort_selected' : ''}
                            >
                                <span className="fa fa-sort-alpha-asc pr-5">
                        ...
                        <li onClick={ () => this.onClick('startdate', -1) }>
                            ...
                            >
                                <span className="fa fa-sort-alpha-desc pr-5">
                                    Ngày bắt đầu xa nhất
                                </span>
                            </a>
                        </li>
                        <li role="separator" className="divider"></li>
                        <li onClick={ () => this.onClick('enddate', 1) }>
                            <a
                                role="button"
                                className={(this.props.sort.by === 'enddate' && this.props.sort.value === 1) ? 'sort_selected' : ''}
                            >
                                <span className="fa fa-sort-alpha-asc pr-5">
